...
@objc public class MicInputErrorHandler: NSObject {
    ...
    private func configureAudioSession() throws {
        ...
        do {
            ...
            if let nsError = error as NSError? {
                ...
                case AVAudioSession.ErrorCode.categoryNotAvailable.rawValue:
                    throw MicInputException(
                        errorType: .formatNotSupported,
                        message: "Record category not available on this device.",
                        cause: error
                    )
    ...
    @objc public func handleEngineError(_ error: Error) -> MicInputException {
        if let nsError = error as NSError? {
            ...
            case AVAudioEngineConfigurationErrorDomain:
